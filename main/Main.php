...
<body>
    ...
    <header>
        ...
        <div class="user-actions">
            <div class="login" onclick="window.location.href='/login/index.html'">
            ...
            <div class="cart" onmouseover="showCartDetail()" onmouseout="hideCartDetail()">
                <span><img src="GioHang.png" alt="Giỏ hàng">Giỏ hàng</span>
                <div class="cart-detail" id="cartDetail">
                    <p>Chưa có sản phẩm nào</p>
                    <p>Tổng: 0đ</p>
                    <button onclick="window.location.href='payment_page.html'">Thanh toán</button>
                </div>
            </div>
        </div>
    </header>
    ...
    <poster>
        <img src="DucthLady_1.jpg" alt="Poster">
    </poster>
    ...
    <main>
        ...
        <div class="products">
            <div class="product">
                <img src="SuaTuoiDutchLady.png" alt="Sữa tươi">
                <h3>Sữa tươi Dutch Lady </h3>
                <p>15.000đ</p>
                <button onclick="addToCart()">Đặt món</button>
            </div>
            <div class="product">
                <img src="SuaBichDutchLady.png" alt="Sữa cao khỏe">
                <h3>Sữa bịch Dutch Lady</h3>
                <p>15.000đ</p>
                <button onclick="addToCart()">Đặt món</button>
            </div>
            <div class="product">
                <img src="SuaBichDutchLady180ml.png" alt="Kem đặc">
                <h3>Sữa bịch Dutch Lady 180ml</h3>
                <p>18.000đ</p>
                <button onclick="addToCart()">Đặt món</button>
            </div>
            <div class="product">
                <img src="SuaBichDutchLadyCaoKhoe.png" alt="Sữa dinh dưỡng">
                <h3>Sữa bịch Dutch Lady Cao Khoẻ</h3>
                <p>20.000đ</p>
                <button onclick="addToCart()">Đặt món</button>
            </div>
            <div class="product">
                <img src="SuaBotNguCocDutchLady.png" alt="Sữa dinh dưỡng">
                <h3>Sữa bột dinh dưỡng ngũ cốc Dutch Lady</h3>
                <p>20.000đ</p>
                <button onclick="addToCart()">Đặt món</button>
            </div>
            <div class="product">
                <img src="SuaTuoiDutchLadyCaoKhoe.png" alt="Sữa dinh dưỡng">
                <h3>Sữa tươi Dutch Lady Cao Khoẻ</h3>
                <p>20.000đ</p>
                <button onclick="addToCart()">Đặt món</button>
            </div>
            <div class="product">
                <img src="SuaDacDutchLady.jpg" alt="Sữa dinh dưỡng">
